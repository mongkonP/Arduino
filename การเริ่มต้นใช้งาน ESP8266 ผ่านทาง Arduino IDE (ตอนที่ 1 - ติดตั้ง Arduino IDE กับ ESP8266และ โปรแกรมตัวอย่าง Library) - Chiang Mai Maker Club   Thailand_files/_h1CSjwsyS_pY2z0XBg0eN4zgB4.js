;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="9aba20cce5c8b0c8c5bd51a684367c2f";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["NaWzprk4Qzzq"]={appId:"XzVIEqe1R2kW",scope:{}};;CloudflareApps.installs["NaWzprk4Qzzq"].options={"ie":6};;CloudflareApps.installs["zCV4JYfPl_Rb"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["zCV4JYfPl_Rb"].options={"account":{"accountId":"2RBMsvIc9k0c","service":"googleanalytics","userId":"106183716970218851207"},"id":"UA-53466330-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['zCV4JYfPl_Rb'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['zCV4JYfPl_Rb'].URLPatterns)){(function(){var options=CloudflareApps.installs['zCV4JYfPl_Rb'].options
...
window.ga('send','social','twitter','tweet',{page:targetUrl})}})}})}}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/_IJkUXSFqR4wktIBCEIkf9hv8Dw.js';document.head.appendChild(script);})();